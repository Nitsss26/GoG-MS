...
export async function POST(req: NextRequest) {
    try {
        ...
        const { to, cc, subject, text, html, attachments, inReplyTo, references } = body;
        ...
        const result = await sendMailInternal({ to: cleanTo, cc: cleanCc, subject, text, html, attachments, inReplyTo, references });

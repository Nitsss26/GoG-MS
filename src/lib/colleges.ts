...
export const INDIAN_HOLIDAYS_2026 = [
    ...
    { date: "2026-03-10", name: "Holi", type: "festival" as const },
    { date: "2026-03-14", name: "Holi (Dhuleti)", type: "festival" as const },
    { date: "2026-04-02", name: "Ram Navami", type: "festival" as const },
    ...
    { date: "2026-06-27", name: "Eid-ul-Fitr", type: "festival" as const },
    { date: "2026-07-07", name: "Muharram", type: "festival" as const },
    { date: "2026-08-15", name: "Independence Day", type: "national" as const },
    { date: "2026-08-16", name: "Janmashtami", type: "festival" as const },
    { date: "2026-09-04", name: "Eid-ul-Adha", type: "festival" as const },
    { date: "2026-10-02", name: "Gandhi Jayanti", type: "national" as const },
    { date: "2026-10-02", name: "Dussehra", type: "festival" as const },
    { date: "2026-10-21", name: "Diwali", type: "festival" as const },
    { date: "2026-10-23", name: "Govardhan Puja", type: "festival" as const },
    { date: "2026-10-24", name: "Bhai Dooj", type: "festival" as const },
    { date: "2026-11-19", name: "Guru Nanak Jayanti", type: "festival" as const },
